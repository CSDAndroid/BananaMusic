...
import com.example.musicapp.model.network.RetrofitInstance
        ...
        override fun onResponse(
            ...
            if (response.isSuccessful) {
                ...
                apiResponse?.data?.forEach { song ->
                    Log.d(
                        "SongData2",
                        "com.example.musicapp.model.database.entity.Song: ${song.song}, Singer: ${song.sing}, ID: ${song.id}  url: ${song.url} pic : ${song.pic}"
                    )
